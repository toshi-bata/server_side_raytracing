	...
	*/
	...
	public:
		...
		*/
		...
		RED_RC
			createEnvMapLightEnvironment(std::string const& a_imageFilepath, bool a_showImage, RED::Color const& a_backgroundColor, const char* thumbFilePath, EnvironmentMapLightingModel& envMap);
